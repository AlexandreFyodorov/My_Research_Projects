...
## ⚙️ Инструментарий и функциональность
Скрипт реализует полный цикл обработки:
- фильтрация ликвидных бумаг;
...
### 1️⃣ Отфильтрованный список компаний
...
### 3️⃣ Интегральный рейтинг
Финальным результатом является **ранжированный список компаний**.  
Чем меньше значение **Composite_Rank**, тем лучше компания выглядит по совокупности факторов:
- дешевизна (низкие мультипликаторы);
- высокая рентабельность;
- низкая долговая нагрузка;
- высокая дивидендная доходность.

Это даёт инвестору **готовый «шорт-лист»** для более глубокого изучения.
