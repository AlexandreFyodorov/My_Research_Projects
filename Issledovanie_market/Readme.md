...
|  5. | [IT-сектор](https://github.com/AlexandreFyodorov/My_Research_Projects/blob/main/Issledovanie_market/analys_it-telecom.ipynb) | [Результат отбора лучших IT-компаний](https://github.com/AlexandreFyodorov/My_Research_Projects/blob/main/Issledovanie_market/Results/analys_it-telecom_results.ipynb)| MTSS, DIAS, TTLK, T, DATA, SOFT, AFKS, RTKM, YDEX, ELMT, ASTR, CNTLP.
